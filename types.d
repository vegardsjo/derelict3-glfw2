...
struct GLFWvidmode
{
  union { int width; int Width; };
  union { int height; int Height; };
  union { int redBits; int RedBits; };
  union { int blueBits; int BlueBits; };
  union { int greenBits; int greenBits; };
}
*/
